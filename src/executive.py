...
def executive_function_output_main(
    ...
    elif user_choice_rub != "да" and user_choice_rub != "нет":
        user_choice_rub = "нет"
    elif user_choice_name_discription != "да" and user_choice_name_discription != "нет":
        user_choice_name_discription = "нет"

    elif user_choice_sort != "по возрастанию" and user_choice_sort != "по убыванию":
        user_choice_sort = True
    elif user_choice_sort == "по убыванию":
        user_choice_sort = True
    else:
