...
def output_execudet_json():
    return """Распечатываю итоговый список транзакций...
85
...
@pytest.fixture
def result_type_operation_dict():
    return (
        "{'Перевод со счета на счет': 110, 'Перевод с карты на карту': 587,"
        + " 'Перевод организации': 117, 'Открытие вклада': 185}"
    )


@pytest.fixture
def input_list_operation_to_count():
    return [
        {
            "id": 1172691.0,
            "state": "EXECUTED",
